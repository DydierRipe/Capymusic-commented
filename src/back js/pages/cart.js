...
// main code functionality, I could have used switch case, but I have heard of its low performance in js
const main = (req) => {
    return new Promise(res => {

        // gets every reserved item by the user
            ...
            database.query(`select name, price, description, seller from products where id = ${req.id}`, async (e, resp) => {
                ...
                (er) => {
                    ...
                    database.query(`delete from products where id = ${req.id}`, err => {
                        ...
                        // funny email lol, it's a shame that I didn't thanslate it
                        utilities.sendEmail(
