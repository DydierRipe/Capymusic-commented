    ...
    return await new Promise(async (res) => {
        ...
        if (req.reason == "Existence") {
            ...
            where email = '${req.email}' or username = '${req.username}'`, (e, resp) => {
                ...
                // user has to be verified first via Email, if not, it will stay at the waitlist
                if (resp.length == 0) {
            ...
            */
            ...
            // once the user is verified, inserts the user into the real users list and deletes it from the wait list
        ...
        // if the user regrets to register, it will be deleted from the waitlist
